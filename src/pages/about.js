...
export default function({ match }) {
  ...
  return (
    <div>
      <menu>
        <Link to={`${match.path}/1`} style={{marginRight: "10px"}}>Page 1</Link>
...
class AboutFirstPage extends React.Component {
  ...
  return (
    <div>
      ...
      <div>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloribus repudiandae atque non 
        natus fugit autem explicabo, architecto labore aut laudantium.
      </div>
    </div>
  );
  }
